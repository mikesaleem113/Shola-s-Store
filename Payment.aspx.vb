...
Public Class Payment
    ...
    Private Sub btnAPI_Click(sender As Object, e As EventArgs) Handles btnAPI.Click
        ...
        post_values.Add("x_login", "8S3m6FMkm") ' your login ID
        post_values.Add("x_tran_key", "44636CN2SdJa5mcg") ' your transaction key
        ...
        post_values.Add("x_exp_date", "0120")
 ...
 HttpWebResponse)
        ...
        'lblAuthorizationCode.Text = strReturnArray(9) + strReturnArray(6) + strReturnArray(6) + strReturnArray(7)
